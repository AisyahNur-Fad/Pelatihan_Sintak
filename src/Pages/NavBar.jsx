    ...
    <div>
      <div className="navbar bg-base-100 shadow-sm sticky top-0 z-50">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              ...
              <li>
                <Link to="/product">Coffe Product</Link>
              </li>
              <li>
        ...
        <div className="navbar-end">
          <Link className="btn mr-2 rounded-lg">Request Link Quote</Link>
          <Link className="btn bg-amber-800 text-white rounded-lg">Contact Us</Link>
        </div>
      </div>
    </div>
  );
